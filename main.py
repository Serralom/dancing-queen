...
application.add_handler(CommandHandler("ranking_hoy", ranking_hoy))
application.add_handler(CommandHandler("ranking_anual", ranking_anual))
application.add_handler(CommandHandler("ranking_historico", ranking_historico))
